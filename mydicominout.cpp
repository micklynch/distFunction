...
double* myDicomInOut::getBounds()
{
    return reader->GetOutput()->GetBounds();
}

void myDicomInOut::readImageFrom(QString filename)
{
...
void myDicomInOut::readImagesFrom(QStringList filenames)
{
    double spacing[3];
    double zspacing;
...
vtkSmartPointer<vtkStringArray> myDicomInOut::sortFilenames(QStringList filenames, double &zSpacing)
{
